...
public class MainActivity extends AppCompatActivity {
    ...
    private static final DataInfoEntry[] DATA_INFO = {
            ...
            new DataInfoEntry("PAIR?", "", false),  new DataInfoEntry("21", "", false),
            new DataInfoEntry("22", "", false),     new DataInfoEntry("23", "", false),
            new DataInfoEntry("24", "", false),     new DataInfoEntry("RPM", "", true),
            new DataInfoEntry("RPM l?", "", false), new DataInfoEntry("TPS", " %", true),
            new DataInfoEntry("IAP1", "", true),    new DataInfoEntry("ECT", " °C", true),
            new DataInfoEntry("IAT", " °C", true),  new DataInfoEntry("IAP1 l?", "", false),
            ...
            new DataInfoEntry("STV?", "", false),   new DataInfoEntry("FUEL1a", "", true),
            new DataInfoEntry("FUEL1b", "", true),  new DataInfoEntry("FUEL2a", "", true),
            new DataInfoEntry("FUEL2b", "", true),  new DataInfoEntry("FUEL?", "", false),
            new DataInfoEntry("FUEL?", "", false),  new DataInfoEntry("FUEL?", "", false),
            new DataInfoEntry("FUEL?", "", false),  new DataInfoEntry("47", "", false),
            new DataInfoEntry("48", "", false),     new DataInfoEntry("IGN1", "", true),
            new DataInfoEntry("IGN2", "", true),    new DataInfoEntry("IGN?", "", false),
            new DataInfoEntry("IGN?", "", false),   new DataInfoEntry("53", "", false),
            new DataInfoEntry("STV", "", true),     new DataInfoEntry("55", "", false),
            new DataInfoEntry("56", "", false),     new DataInfoEntry("57", "", false),
            new DataInfoEntry("MODE?", "", false),  new DataInfoEntry("PAIR", "", true),
